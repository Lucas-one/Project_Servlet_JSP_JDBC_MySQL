...
<body>
    ...
    <div id="notice">
        <div class="content-container">
            <span class="title">YJ의 JSP/Servlet활용 <span style="color:yellow;font-size:15px;">IT PROFESSIONAL <span style="color:#00ffff;">JSP</span>
                    Servlet <span style="color:#00ffff;">Study</span>Practice</span></span>
    ...
    <div id="information">
        <div class="content-container">
            <section class="guide">
                <h1 class="title">유튜브를 통해 많이 학습</h1>
            ...
            <section class="course-info">
                <h1 class="title text-center">어떤 게시글들을 추가할까</h1>
                <ul class="list">
                    <li>현재 게시글이 없습니다.</li>
                </ul>
            </section>
                ...
                <ul class="list margin-top">
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="notice/detail.html">li태그로 구현</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="notice/detail.html">html은 많이 공부함</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="notice/detail.html">spring공부 다하고</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="notice/detail.html">자바스크립트도 해야지</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="notice/detail.html">css도 공부해야하는데</a>
                        </span>
        ...
        <section class="content-container list list-horizontal list-course list-course-index">
            ...
            <ul>
                ...
                <li class="item-course normal event">
                    ...
                    <div>
                        <div>
                            <a href="course/2"><span class="text-strong text-ellipsis">newlec님 강의로 공부</span></a>
                        </div>
                        <div class="price">
                            <span class="normal deprecated">
                                <span class="text-gray">
